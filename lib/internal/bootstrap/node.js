...
const { getSourceMap } = require('internal/source_map');
...
// Set up methods on the process object for all threads
{
  ...
  process._applySourceMap = function (errorString) {
    // TODO: parse error string, extract the appropriate
    // column and line offsets, and rewrite it.
    getSourceMap('get-file-name-from-error-string-here');
    return `${errorString}`;
  }
}
